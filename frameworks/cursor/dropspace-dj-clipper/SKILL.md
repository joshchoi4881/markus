...
Edit `apps/myapp/app.json` with your event/artist details. Set up Google Workspace credentials for Drive access if needed (see `templates/dropspace-dj-clipper/SETUP.md`).
