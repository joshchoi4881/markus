...
**Data:** `~/dropspace/apps/{app}/tiktok/` (strategy.json, posts.json, failures.json, pending-batches.json, posts/)
**App config:** `~/dropspace/apps/{app}/app.json` (single source of truth for app identity, integrations, platform settings)
